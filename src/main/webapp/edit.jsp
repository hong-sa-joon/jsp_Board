...
<body>
 	<div class="board_wrap">
 		...
 		<div class="board_write_wrap">
			<form action="update?board_no=${board.board_no}" method="post" name="frm" enctype="multipart/form-data">
				<div class="board_write">
					<div class="title">
					 <dl>
					 	<dt>제목</dt>
					 	<dd><input type="text" name="title" maxlength="50" value="${board.title}" /> 
					 	</dd>
					 </dl>
					</div>
					<div class="info">
					...
					<div style="padding-top:10px;">
						...
						<img alt="업로드 이미지" width="100"src="${board.img}" />
						</c:if>
